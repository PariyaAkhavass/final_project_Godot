...
@onready var food_gathered: Label = $food_gathered

#list of levels
var levels := ["forest", "tundra", "desert", "sea"]
@onready var scene_forest = load("res://scenes/forest.tscn")
@onready var scene_tundra = load("res://scenes/tundra.tscn")
@onready var scene_desert = load("res://scenes/desert.tscn")
@onready var scene_island = load("res://scenes/island.tscn")
